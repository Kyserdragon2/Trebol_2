...
public class Celda_TextoCentrado extends DefaultTableCellRenderer {
    ...
    public Celda_TextoCentrado(Color background, Color foreground, int col) {
        super();
        this.background = background;
        this.foreground = foreground;
        this.font = new Font("Calibri", Font.BOLD, 12);
        this.columna = col;
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        if (value instanceof JButton) {
            ...
            switch (btn.getName()) {
                case "ver":
                    btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sistema_Imagenes/ver2.png")));
                    if (isSelected) {
                        btn.setBackground(new Color(162, 219, 238));
                    ...
                    break;
                case "aceptar":
                    btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sistema_Imagenes/ok.png")));
                    if (isSelected) {
                        btn.setBackground(new Color(162, 219, 238));
                        btn.setForeground(new Color(255, 255, 255));
                    } else {
                    ...
                    break;
                case "ver3":
                    btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sistema_Imagenes/ver3.png")));
                    if (isSelected) {
                        btn.setBackground(new Color(162, 219, 238));
                        btn.setForeground(new Color(255, 255, 255));
                    } else {
                    ...
                    break;
                case "editar":
                    btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sistema_Imagenes/edicion.png")));
                    if (isSelected) {
                        btn.setBackground(new Color(162, 219, 238));
                        btn.setForeground(new Color(255, 255, 255));
                    } else {
                    ...
                    break;
                case "borrar":
                    btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Sistema_Imagenes/borrar.png")));
                    if (isSelected) {
                        btn.setBackground(new Color(162, 219, 238));
                        btn.setForeground(new Color(255, 255, 255));
                    } else {
            ...
            btn.setSize(40, 19);
            btn.setFont(new Font("Calibri", 1, 12));
            btn.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
            return btn;
        }

        if (value instanceof RSProgressBar) {
            RSProgressBar rspb = (RSProgressBar) value;
            if (isSelected) {
                switch (rspb.getName()) {
                    case "progreso":
                        rspb.setBackground(new Color(150, 150, 150));
                        rspb.setForeground(new Color(0, 91, 122));
                        break;
                    default:
                        break;
                }
                rspb.setColorSelForeground(Color.black);
                rspb.setBackground(new Color(150, 150, 150));
            } else {
                switch (rspb.getName()) {
                    case "progreso":
                ...
                rspb.setColorSelForeground(Color.black);
                rspb.setBackground(Color.white);
            }
            rspb.setFont(new Font("Calibri", Font.BOLD, 12));
            rspb.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0), 1),
            ...
            if (columna == 5 && !table.getValueAt(row, 8).toString().equals("Finalizada")
                ...
                if (!table.getValueAt(row, 5).toString().equals("N/A")) {
                    ...
                    try {
                        ...
                        Logger.getLogger(Celda_TextoCentrado.class.getName()).log(Level.SEVERE, null, e);
                    }
                } else {
