...
CREATE TABLE `trebol_anticipos` (
  ...
  `cargado` tinyint(2) NOT NULL DEFAULT '0',
  `anulado` tinyint(2) NOT NULL DEFAULT '0',
  `ub_documento` varchar(255) COLLATE utf8_spanish_ci NOT NULL,
  `creacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modificacion` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `id_factura` (`id`),
  KEY `id_tipo_factura` (`id_proveedor`),
  KEY `id_empresa` (`id_empresa`),
  CONSTRAINT `trebol_anticipos_ibfk_1` FOREIGN KEY (`id_proveedor`) REFERENCES `trebol_proveedor` (`id`),
  CONSTRAINT `trebol_anticipos_ibfk_2` FOREIGN KEY (`id_empresa`) REFERENCES `trebol_empresa` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

/*Data for the table `trebol_anticipos` */

/*Table structure for table `trebol_anticipos_fact` */

DROP TABLE IF EXISTS `trebol_anticipos_fact`;

CREATE TABLE `trebol_anticipos_fact` (
  ...
  CONSTRAINT `trebol_anticipos_fact_ibfk_1` FOREIGN KEY (`id_factura`) REFERENCES `trebol_facturas` (`id`),
  CONSTRAINT `trebol_anticipos_fact_ibfk_2` FOREIGN KEY (`id_tipo_factura`) REFERENCES `trebol_tipo_factura` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `trebol_anticipos_fact` */

insert  into `trebol_anticipos_fact`(`id_factura`,`id_tipo_factura`,`creacion`,`modificacion`) values 
(6,1,'2019-12-26 09:16:44','2019-12-26 09:16:44');
...
insert  into `trebol_aprobaciones`(`id_factura`,`id_area`,`id_usuario`,`aprobado`,`creacion`,`modificacion`) values 
(3,1,14,1,'2019-12-26 08:42:59','2019-12-26 08:42:59'),
(5,1,14,1,'2019-12-26 08:47:01','2019-12-26 08:47:01'),
(6,1,14,1,'2019-12-26 08:48:47','2019-12-26 08:48:47'),
(7,1,14,1,'2019-12-26 08:50:06','2019-12-26 08:50:06');
...
insert  into `trebol_comentarios`(`id`,`id_factura`,`id_usuario`,`id_estado`,`detalle`,`creacion`,`modificacion`) values 
(1,1,14,11,'Número de Factura Incorrecto','2019-12-26 08:51:56','2019-12-26 08:51:56'),
(2,2,14,11,'Hace falta el anexo recibido con la factura','2019-12-26 09:12:23','2019-12-26 09:12:23'),
(3,4,14,11,'El valor cargado en el sistema no corresponde al de la factura','2019-12-26 09:16:27','2019-12-26 09:16:27');
...
insert  into `trebol_correos`(`id`,`id_factura`,`enviado`,`fecha_enviado`,`destinatario`,`asunto`,`mensaje`,`creacion`,`modificacion`) values 
(1,1,0,NULL,'jcasallas@snider.com.co,lurquijo@aviomar.com.co','Asignacion de Factura','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Nueva                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n57052433-8                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n$303.030,00                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nSonia Santos                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:39:21','2019-12-26 08:39:21'),
(2,2,0,NULL,'jcasallas@snider.com.co,lurquijo@aviomar.com.co','Asignacion de Factura','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Nueva                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n570524341-9                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n$283.560,00                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nSonia Santos                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:41:06','2019-12-26 08:41:06'),
(3,3,0,NULL,'jcasallas@snider.com.co,lurquijo@aviomar.com.co','Asignacion de Factura','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Nueva                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n570524342-6                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n$3.684.120,00                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nSonia Santos                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:43:00','2019-12-26 08:43:00'),
(4,4,0,NULL,'jcasallas@snider.com.co,lurquijo@aviomar.com.co','Asignacion de Factura','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Nueva                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n570524343-3                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n$2.840.000,00                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nSonia Santos                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:44:46','2019-12-26 08:44:46'),
(5,5,0,NULL,'jcasallas@snider.com.co,lurquijo@aviomar.com.co','Asignacion de Factura','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Nueva                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n570524344-0                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n$42.040,00                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nSonia Santos                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:47:01','2019-12-26 08:47:01'),
(6,6,0,NULL,'jcasallas@snider.com.co,lurquijo@aviomar.com.co','Asignacion de Factura','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Nueva                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n273402380                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n899999115                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nEMPRESA DE TELECOMUNICACIONES DE BOGOTA SA ESP                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n$5.159.245,00                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n27/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nSonia Santos                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:48:47','2019-12-26 08:48:47'),
(7,7,0,NULL,'jcasallas@snider.com.co,lurquijo@aviomar.com.co','Asignacion de Factura','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Nueva                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n196499                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n900632226                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nMENSAJEROS URBANOS                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n$133.800,00                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ffcc33; border: 3px outset #ffcc33; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; text-align: center; background: #ffffff;\">\nSonia Santos                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ffcc33; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:50:06','2019-12-26 08:50:06'),
(8,1,0,NULL,'recepcion.calle96@aviomar.com,mcaicedo@colvan.com.co,ssantos@snider.com.co, archivo@aviomar.com.co,archivo@aviomar.com.co,mdelgado@aviomar.com.co','Factura Rechazada','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Rechazada                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n57052433-8                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n$303.030,00                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n19/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nJuan Gabriel Casallas                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 08:51:56','2019-12-26 08:51:56'),
(9,2,0,NULL,'recepcion.calle96@aviomar.com,mcaicedo@colvan.com.co,ssantos@snider.com.co, archivo@aviomar.com.co,archivo@aviomar.com.co,mdelgado@aviomar.com.co','Factura Rechazada','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Rechazada                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n570524341-9                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n$283.560,00                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n19/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nJuan Gabriel Casallas                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 09:12:24','2019-12-26 09:12:24'),
(10,3,0,NULL,'asistente_contable2@aviomar.com.co,asistente_contable1@aviomar.com.co','Factura para Contabilizar','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura para Contabilizar                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n570524342-6                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n$3.684.120,00                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n19/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nJuan Gabriel Casallas                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 09:15:55','2019-12-26 09:15:55'),
(11,4,0,NULL,'recepcion.calle96@aviomar.com,mcaicedo@colvan.com.co,ssantos@snider.com.co, archivo@aviomar.com.co,archivo@aviomar.com.co,mdelgado@aviomar.com.co','Factura Rechazada','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura Rechazada                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n570524343-3                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n$2.840.000,00                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n19/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #ff3333; border: 3px outset #ff3333; color:white; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; text-align: center; background: #ffffff;\">\nJuan Gabriel Casallas                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #ff3333; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 09:16:27','2019-12-26 09:16:27'),
(12,5,0,NULL,'asistente_contable2@aviomar.com.co,asistente_contable1@aviomar.com.co','Factura para Contabilizar','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura para Contabilizar                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n570524344-0                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n830037248                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nAV018210                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nCODENSA S A                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n$42.040,00                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n19/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n30/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nJuan Gabriel Casallas                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 09:16:36','2019-12-26 09:16:36'),
(13,6,0,NULL,'asistente_contable2@aviomar.com.co,asistente_contable1@aviomar.com.co','Factura para Contabilizar','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura para Contabilizar                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n273402380                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n899999115                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nnull                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nEMPRESA DE TELECOMUNICACIONES DE BOGOTA SA ESP                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n$5.159.245,00                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n20/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n27/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nJuan Gabriel Casallas                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 09:16:45','2019-12-26 09:16:45'),
(14,7,0,NULL,'asistente_contable2@aviomar.com.co,asistente_contable1@aviomar.com.co','Factura para Contabilizar','<html>\n    <head>\n        <title>TODO supply a title</title>\n        <meta charset=\"UTF-8\">\n        <meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\">\n    </head>\n    <body>\n        <table style=\" width: 700px; text-align: center;table-layout:fixed; \" align=\"Center\">\n                <tr>\n                    <td style=\"font-size: 25px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri;\" colspan=\"4\" align=\"center\">\n                        <strong>\nFactura para Contabilizar                        </strong></td>\n                </tr>\n                <tr>\n                    <td style=\"width: 130px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Factura: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n196499                    </td>\n                    <td style=\"width: 170px; font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Empresa: \n                        </strong>\n                    </td>\n                    <td style=\"width: 200px; font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nAviomar                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            NIT: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n900632226                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Radicado: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nnull                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Proveedor: \n                        </strong>\n                    </td>\n                    <td  colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\">\n                        <textarea name=\"proveedor\" rows=\"3\" cols=\"55\" readonly=\"readonly\" style=\"font-size: 20px; font-family: Calibri; background: none; text-align: left;\">\nMENSAJEROS URBANOS                        </textarea>\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Valor: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n$133.800,00                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Recepcion: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n26/12/2019                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Factura: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n17/12/2019                    </td>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Fecha Vencimiento: \n                        </strong>\n                    </td>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\n                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; background: #2222ff; border: 3px outset #2222ff; color:black; font-family: Calibri; text-align: right;\">\n                        <strong>\n                            Creada por: \n                        </strong>\n                    </td>\n                    <td colspan=\"3\" style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; text-align: center; background: #ffffff;\">\nJuan Gabriel Casallas                    </td>\n                </tr>\n                <tr>\n                    <td style=\"font-size: 20px; font-family: Calibri; border: 3px outset #2222ff; background: #ffffff;\"  colspan=\"4\" align=\"Center\">\n                        <img style=\"margin-right: 10px; margin-left: 10px; opacity: 0.6;\" src=\"http://186.29.91.156/Imagenes%20Publicas/Empresa2.png\"/>\n                    </td>\n                </tr>\n        </table>\n    </body>\n</html>','2019-12-26 09:17:40','2019-12-26 09:17:40');
...
insert  into `trebol_documentos`(`id_factura`,`id_tipo_doc`,`consecutivo`,`ubicacion`,`creacion`,`modificacion`) values 
(1,1,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/57052433-8/Factura.pdf','2019-12-26 08:39:19','2019-12-26 08:39:19'),
(1,2,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/57052433-8/Anexo Recibido con la Factura.pdf','2019-12-26 08:39:20','2019-12-26 08:39:20'),
(2,1,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/570524341-9/Factura.pdf','2019-12-26 08:41:05','2019-12-26 08:41:05'),
(3,1,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/570524342-6/Factura.pdf','2019-12-26 08:42:58','2019-12-26 08:42:58'),
(3,2,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/570524342-6/Anexo Recibido con la Factura.pdf','2019-12-26 08:42:59','2019-12-26 08:42:59'),
(4,1,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/570524343-3/Factura.pdf','2019-12-26 08:44:44','2019-12-26 08:44:44'),
(4,2,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/570524343-3/Anexo Recibido con la Factura.pdf','2019-12-26 08:44:45','2019-12-26 08:44:45'),
(5,1,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/570524344-0/Factura.pdf','2019-12-26 08:47:00','2019-12-26 08:47:00'),
(5,2,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/CODENSA S A/570524344-0/Anexo Recibido con la Factura.pdf','2019-12-26 08:47:01','2019-12-26 08:47:01'),
(6,1,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/EMPRESA DE TELECOMUNICACIONES DE BOGOTA SA ESP/273402380/Factura.pdf','2019-12-26 08:48:47','2019-12-26 08:48:47'),
(7,1,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/MENSAJEROS URBANOS/196499/Factura.pdf','2019-12-26 08:50:06','2019-12-26 08:50:06'),
(7,2,NULL,'//10.0.2.6/Aviomar-R/APLICACIONES/Treból_V2/Facturas/Aviomar/MENSAJEROS URBANOS/196499/Anexo Recibido con la Factura.pdf','2019-12-26 08:50:06','2019-12-26 08:50:06');
...
insert  into `trebol_factura_convenio`(`id_factura`,`id_convenio`,`activo`,`creacion`,`modificacion`) values 
(1,39,1,'2019-12-26 08:39:21','2019-12-26 08:39:21'),
(2,38,1,'2019-12-26 08:41:05','2019-12-26 08:41:05'),
(3,35,1,'2019-12-26 08:42:59','2019-12-26 08:42:59'),
(4,36,1,'2019-12-26 08:44:45','2019-12-26 08:44:45'),
(5,37,1,'2019-12-26 08:47:01','2019-12-26 08:47:01'),
(6,51,1,'2019-12-26 08:48:47','2019-12-26 08:48:47');
...
insert  into `trebol_facturas`(`id`,`no_factura`,`valor`,`moneda`,`fecha_generada`,`fecha_venc`,`no_radicado`,`aprobada`,`revisada`,`id_proveedor`,`id_tipo_factura`,`id_gestion`,`id_area`,`id_empresa`,`id_estado`,`creacion`,`modificacion`) values 
(1,'57052433-8',303030.00,'COP','2019-12-19','2019-12-30','AV018210',0,0,14,28,7,1,1,11,'2019-12-26 08:39:17','2019-12-26 08:39:17'),
(2,'570524341-9',283560.00,'COP','2019-12-19','2019-12-30','AV018210',0,0,14,28,7,1,1,11,'2019-12-26 08:41:04','2019-12-26 08:41:04'),
(3,'570524342-6',3684120.00,'COP','2019-12-19','2019-12-30','AV018210',1,0,14,28,4,1,1,4,'2019-12-26 08:42:57','2019-12-26 08:42:57'),
(4,'570524343-3',2840000.00,'COP','2019-12-19','2019-12-30','AV018210',0,0,14,28,7,1,1,11,'2019-12-26 08:44:43','2019-12-26 08:44:43'),
(5,'570524344-0',42040.00,'COP','2019-12-19','2019-12-30','AV018210',1,0,14,28,4,1,1,4,'2019-12-26 08:46:59','2019-12-26 08:46:59'),
(6,'273402380',5159245.00,'COP','2019-12-20','2019-12-27',NULL,1,0,34,28,4,1,1,4,'2019-12-26 08:48:46','2019-12-26 08:48:46'),
(7,'196499',133800.00,'COP','2019-12-17',NULL,NULL,1,0,49,27,4,1,1,4,'2019-12-26 08:50:05','2019-12-26 08:50:05');
...
insert  into `trebol_logs`(`id_usuario`,`id_factura`,`id_comentario`,`id_estado`,`creacion`,`modificacion`) values 
(4,1,NULL,6,'2019-12-26 08:39:21','2019-12-26 08:39:21'),
(4,2,NULL,6,'2019-12-26 08:41:05','2019-12-26 08:41:05'),
(4,3,NULL,6,'2019-12-26 08:42:59','2019-12-26 08:42:59'),
(4,4,NULL,6,'2019-12-26 08:44:45','2019-12-26 08:44:45'),
(4,5,NULL,6,'2019-12-26 08:47:01','2019-12-26 08:47:01'),
(4,6,NULL,6,'2019-12-26 08:48:47','2019-12-26 08:48:47'),
(4,7,NULL,6,'2019-12-26 08:50:06','2019-12-26 08:50:06'),
(14,1,1,11,'2019-12-26 08:51:56','2019-12-26 08:51:56'),
(14,2,2,11,'2019-12-26 09:12:24','2019-12-26 09:12:24'),
(14,3,NULL,2,'2019-12-26 09:15:55','2019-12-26 09:15:55'),
(14,4,3,11,'2019-12-26 09:16:27','2019-12-26 09:16:27'),
(14,5,NULL,2,'2019-12-26 09:16:35','2019-12-26 09:16:35'),
(14,6,NULL,2,'2019-12-26 09:16:45','2019-12-26 09:16:45'),
(14,7,NULL,2,'2019-12-26 09:17:39','2019-12-26 09:17:39');
...
CREATE TABLE `trebol_sistema_uno` (
  ...
  `no_factura` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
...
insert  into `trebol_tiempos`(`id_usuario`,`id_factura`,`id_estado_prev`,`id_estado_post`,`creacion`,`modificacion`) values 
(4,1,6,14,'2019-12-26 08:39:21','2019-12-26 08:39:21'),
(4,1,14,8,'2019-12-26 08:39:21','2019-12-26 08:39:21'),
(4,2,6,14,'2019-12-26 08:41:05','2019-12-26 08:41:05'),
(4,2,14,8,'2019-12-26 08:41:06','2019-12-26 08:41:06'),
(4,3,6,14,'2019-12-26 08:43:00','2019-12-26 08:43:00'),
(4,3,14,8,'2019-12-26 08:43:00','2019-12-26 08:43:00'),
(4,4,6,14,'2019-12-26 08:44:46','2019-12-26 08:44:46'),
(4,4,14,8,'2019-12-26 08:44:46','2019-12-26 08:44:46'),
(4,5,6,14,'2019-12-26 08:47:01','2019-12-26 08:47:01'),
(4,5,14,8,'2019-12-26 08:47:01','2019-12-26 08:47:01'),
(4,6,6,14,'2019-12-26 08:48:47','2019-12-26 08:48:47'),
(4,6,14,8,'2019-12-26 08:48:47','2019-12-26 08:48:47'),
(4,7,6,14,'2019-12-26 08:50:06','2019-12-26 08:50:06'),
(4,7,14,8,'2019-12-26 08:50:06','2019-12-26 08:50:06'),
(14,1,8,11,'2019-12-26 08:51:56','2019-12-26 08:51:56'),
(14,2,8,11,'2019-12-26 09:12:24','2019-12-26 09:12:24'),
(14,3,2,4,'2019-12-26 09:15:55','2019-12-26 09:15:55'),
(14,4,8,11,'2019-12-26 09:16:27','2019-12-26 09:16:27'),
(14,5,2,4,'2019-12-26 09:16:35','2019-12-26 09:16:35'),
(14,6,2,4,'2019-12-26 09:16:45','2019-12-26 09:16:45'),
(14,7,2,4,'2019-12-26 09:17:39','2019-12-26 09:17:39');
...
CREATE TABLE `trebol_usuario` (
  ...
  `sesion_activa` int(2) NOT NULL DEFAULT '0',
...
insert  into `trebol_usuario`(`id`,`usuario`,`nombres`,`apellidos`,`correo`,`contraseña`,`id_area`,`id_empresa`,`aprueba`,`sesion_activa`,`retirado`,`creacion`,`modificacion`) values 
(1,'Administrador','Admin','DB','N/A','81dc9bdb52d04dc20036dbd8313ed055',10,1,0,0,0,'2019-11-28 14:12:05','2019-11-28 14:12:05'),
(2,'mcamacho','Monica','Camacho','recepcion.calle96@aviomar.com','81dc9bdb52d04dc20036dbd8313ed055',7,1,0,0,0,'2019-12-11 14:53:53','2019-12-11 14:53:53'),
(3,'mcaicedo','Monica','Caicedo','mcaicedo@colvan.com.co','81dc9bdb52d04dc20036dbd8313ed055',7,2,0,0,0,'2019-12-11 15:28:13','2019-12-11 15:28:13'),
(4,'ssantos','Sonia','Santos','ssantos@snider.com.co','81dc9bdb52d04dc20036dbd8313ed055',7,3,0,0,0,'2019-12-11 15:28:39','2019-12-11 15:28:39'),
(5,'bramirez','Bernardo','Ramirez','archivo@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',6,1,0,0,0,'2019-12-11 15:31:01','2019-12-11 15:31:01'),
(6,'jsuarez','Juan Carlos','Suarez','archivo@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',6,1,0,0,0,'2019-12-11 15:32:07','2019-12-11 15:32:07'),
(7,'mdelgado','Milton','Delgado','mdelgado@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',6,1,0,0,0,'2019-12-11 15:33:06','2019-12-11 15:33:06'),
(8,'asanchez','Angelica','Sanchez','capital.humano@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',2,1,0,0,0,'2019-12-11 16:37:08','2019-12-11 16:37:08'),
(9,'masanchez','Maritza','Sanchez','masanchez@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',2,1,1,0,0,'2019-12-11 16:39:15','2019-12-11 16:39:15'),
(10,'amontano','Andersson','Montaño','amontano@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',8,1,1,0,0,'2019-12-11 16:42:05','2019-12-11 16:42:05'),
(11,'alimas','Angie','Limas','practicante_tecnologia@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',8,1,0,0,0,'2019-12-11 16:43:03','2019-12-11 16:43:03'),
(12,'djimenez','Dario','Jimenez','dcruz@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',8,1,0,0,0,'2019-12-11 16:44:48','2019-12-11 16:44:48'),
(13,'cjaime','Carlos','Jaime','cjaime@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',8,1,0,0,0,'2019-12-11 16:48:02','2019-12-11 16:48:02'),
...
(21,'amarenco','Andres','Marenco','amarenco@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',5,1,0,0,0,'2019-12-11 16:57:15','2019-12-11 16:57:15'),
(22,'xbarrera','Ximena','Barrera','xbarrera@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',5,1,0,0,0,'2019-12-11 16:58:03','2019-12-11 16:58:03'),
(23,'aestevez','Adriana','Estevez','aestevez@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',5,1,0,0,0,'2019-12-11 16:58:39','2019-12-11 16:58:39'),
(24,'cescobar','Claudia','Escobar','tesoreria@colvan.com.co','81dc9bdb52d04dc20036dbd8313ed055',9,2,0,0,0,'2019-12-11 16:59:40','2019-12-11 16:59:40'),
(25,'drojas','David','Rojas','auxiliartesoreria@snider.com.co','81dc9bdb52d04dc20036dbd8313ed055',9,3,0,0,0,'2019-12-11 17:00:27','2019-12-11 17:00:27'),
(26,'aagudelo','Angela','Agudelo','asistentefinanciero@aviomar.com.co','81dc9bdb52d04dc20036dbd8313ed055',9,1,0,0,0,'2019-12-11 17:01:09','2019-12-11 17:01:09'),
(27,'dflorez','Carolina','Florez','N/A','81dc9bdb52d04dc20036dbd8313ed055',9,1,0,0,0,'2019-12-11 17:02:00','2019-12-11 17:02:00');
